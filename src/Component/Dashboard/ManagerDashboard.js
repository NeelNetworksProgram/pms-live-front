...
export const ManagerDashboard = ({ isOpen, setIsOpen }) => {
    ...
    <>
      ...
      >
        ...
        >
              ...
              <div>
                ...
                <div>
                  {getProjects("Completed").length > 0 ? (
                    ...
                    <>
                      <p>None of the projects are fully completed yet</p>
                    </>
                  )}
                </div>
              </div>
          ...
          {/* Quick links section */}
          {/* <div className="dashboard__employees-working-on_quick-links">
            <div
            ...
            >
              ...
              <div className="manager__dashboard-quick-links__blocks">
                <NavLink
