...
const ProjectDescriptionModal = ({ projectDescriptionData }) => {
  // states
  ...
  return (
    <div>
      ...
      <Button
        ...
        data-bs-target={`#exampleModal-${projectDescriptionData.Project_id}`}
      >
      ...
      <div
        ...
        id={`exampleModal-${projectDescriptionData.Project_id}`}
        tabIndex="-1"
        aria-hidden="true"
      >
