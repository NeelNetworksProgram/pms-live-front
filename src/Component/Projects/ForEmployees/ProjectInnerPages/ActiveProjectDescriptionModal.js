...
const ActiveProjectDescriptionModal = ({ projectDescriptionData }) => {
  // states
  ...
  return (
    <div>
      ...
      <Button
        ...
        data-bs-target={`#exampleModal2-${projectDescriptionData.Project_id}`}
      >
      ...
      <div
        ...
        id={`exampleModal2-${projectDescriptionData.Project_id}`}
        tabIndex="-1"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            ...
            <div className="project-description-modal-body">
              <div className="project-description-modal-body__header text-dark">
...
export default ActiveProjectDescriptionModal;
